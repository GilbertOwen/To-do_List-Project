...
export default function Benefit() {
  ...
  return (
    <section
      id="benefits"
      className="snap-always snap-center h-screen md:h-fit overflow-hidden w-full pt-12 gap-y-4 md:gap-y-10 pb-24 px-6 md:px-10 lg:px-20 flex flex-col items-center"
    >
